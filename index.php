...
<body>
	<div class="container">
		...
		<div class="jumbotron jmfc-background-color mt-4 p-3">
			...
			<hr>
			<p>Mit diesem Formular kannst du uns ganz anonym dein <strong>Feedback zu unserem Osterkurs 2022</strong> zukommen lassen.</p>
			...
			<form name="form" method="POST" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-12">
						<textarea name="important" class="form-control" rows="8"><?php if (isset($_POST["important"]) === true) echo ($_POST["important"]); ?></textarea>
					</div>
				</div>
				...
				<div class="form-group mt-4">
					...
					<div class="col-12">
						<textarea name="referrer" class="form-control" rows="8"><?php if (isset($_POST["referrer"]) === true) echo ($_POST["referrer"]); ?></textarea>
					</div>
				</div>
				<div class="form-group mt-4">
					<label class="control-label col-12" for="referrer">
					...
					<div class="col-12">
						<textarea name="misc" class="form-control" rows="8"><?php if (isset($_POST["misc"]) === true) echo ($_POST["misc"]); ?></textarea>
					</div>
				</div>
				<hr>
				<div class="form-group mt-4">
